...
const state = {
  ...
  menu: [{
    ...
    },
    {
      ...
      title: '学生管理',
      icon: 'icon-role',
      content:[{item1:'学生管理',path:'/studentManage'},{item2: '添加学生',path: '/addStudent'},{item3: '录入成绩',path: '/addScore'}],
    },
    // {
    //   index: '5',
    //   title: '教师管理',
...
const mutations = {
  ...
  toggle(state) {
    state.flag = !state.flag //置反
  },

  changeUserInfo(state,info) {  //传入两个值来改变state
    state.userInfo = info
