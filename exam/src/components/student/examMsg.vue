        ...
        <el-collapse-item class="header" name="0">
          <template slot="title" class="stitle" >
            <div class="title">
              ...
              <el-button type="primary" size="small">点击查看题库</el-button>
            </div>
          </template>
          <el-collapse class="inner">
            <el-collapse-item>
              <template slot="title" name="1">
                <div class="titlei">选择题 (共{{topicCount[0]}}题 1题2分)</div>
              </template>
              <div class="contenti">
            ...
            <el-collapse-item>
              <template slot="title" name="2">
                <div class="titlei">填空题 (共{{topicCount[1]}}题  1题2分)</div>
              </template>
              <div class="contenti">
            ...
            <el-collapse-item>
              <template slot="title" name="3">
                <div class="titlei">判断题 (共{{topicCount[2]}}题 1题2分)</div>
              </template>
              <div class="contenti">
    ...
    init() {
      ...
      this.$axios(`/api/exam/${examCode}`).then(res => {  //通过examCode请求试卷详细信息
        ...
        this.$axios(`/api/paper/${paperId}`).then(res => {  //通过paperId获取试题题目信息
          ...
          keys.forEach(e => {
            let data = this.topic[e]  //取出一个题型的题目
